...
for index = 1:4
    startP1 = ([-offsetLightCurtain, offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    endP1 = ([offsetLightCurtain, offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    plot3([startP1(1), endP1(1)], [startP1(2), endP1(2)], [startP1(3), endP1(3)], 'r');
    
    startP2 = ([offsetLightCurtain, offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    endP2 = ([offsetLightCurtain, -offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    plot3([startP2(1), endP2(1)], [startP2(2), endP2(2)], [startP2(3), endP2(3)], 'r');
    
    startP3 = ([offsetLightCurtain, -offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    endP3 = ([-offsetLightCurtain, -offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    plot3([startP3(1), endP3(1)], [startP3(2), endP3(2)], [startP3(3), endP3(3)], 'r');
    
    startP4 = ([-offsetLightCurtain, -offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
    endP4 = ([-offsetLightCurtain, offsetLightCurtain, tableHeight + 0.05 + offsetVertical]);
