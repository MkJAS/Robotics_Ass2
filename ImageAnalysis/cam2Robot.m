function [object] = cam2Robot(image)
    ...
    for i = 1:size(channel3Max, 2)
        ...
        cameraPoint = transl(axisAlignedRobot);
        robotToCamera = transl(335.5, 0, 528); %transform from robot to camera
        transform = robotToCamera * cameraPoint;
        Worldcenters(1, :, i) = transform(1:3, 4)';
